...
class Item : virtual public Thing, public ItemAttributes
{
	public:
		...
		std::string getPoke() const;
		std::string getPokeNick() const;
		std::string getPokePrice() const;
		std::string getPPrice() const;
		uint8_t getPokeBoost() const;
		...
		virtual int32_t getAllPokeBalls() const;
		void getLight(LightInfo& lightInfo);

		int32_t getMaxWriteLength() const {return items[id].maxTextLen;}
		int64_t getWorth() const {return getItemCount() * items[id].worth;} //65kitem
        ...
        bool forceHouseSerialize() const {return items[id].forceSerialize || canWriteText() || isContainer() || isBed() || isDoor() || items[id].type == ITEM_TYPE_CARPET;}
        ...
        bool isPokesNick() const;
        bool isPokesBoost() const;
        bool getBallOn() const;
        bool getBallUse() const;
        bool getBallOff() const;
...
inline std::string Item::getBall() const
{
        boost::any value = getAttribute("ball");
...
inline std::string Item::getPoke() const
{
...
inline std::string Item::getPokeNick() const
{
...
inline uint8_t Item::getPokeBoost() const
{
...
inline std::string Item::getPokePrice() const
{
        boost::any value = getAttribute("poke");
	const char* v = boost::any_cast<std::string>(value).c_str();
	std::stringstream s;
