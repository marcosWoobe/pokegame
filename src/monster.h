...
class Monster : public Creature
{
	...
	public:
           ...
           std::map <std::string, bool> listBlack;
           uint32_t price;
           uint16_t fly,ride,surf;
           bool rocksmash, dig, cut, blink, light, cmid, headbutt;
           bool passive;
...
//		bool getCanWalkEverywhere() const {return canWalkEverywhere;}
        ...
        void addToBlackList(Creature* creature);
        void removeFromBlackList(Creature* creature);
        bool isInBlackList(const Creature* creature);
        void setPassive(bool parampassive = false){passive = parampassive;}
        void clearBlackList();
