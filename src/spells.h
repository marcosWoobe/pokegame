...
class InstantSpell : public TalkAction, public Spell
{
	public:
		...
		virtual bool castSpell(Creature* creature, std::string moveS);
		virtual bool castSpell(Creature* creature, Creature* target, std::string moveS);

		//scripting
		bool executeCastSpell(Creature* creature, std::string var);
	...
	protected:
		...
		bool internalCastSpell(Creature* creature, std::string var);
