...
enum CombatType_t
{
	...
	COMBAT_PHYSICALDAMAGE	= 1 << 0,
	COMBAT_VENOMDAMAGE	= 29,
	COMBAT_TESTDAMAGE	= 30,
	COMBAT_PSYCHICDAMAGE	= 1 << 1,//1
	COMBAT_GRASSDAMAGE	= 1 << 2,//4
	COMBAT_FIREDAMAGE	= 1 << 3,//8
	COMBAT_UNDEFINEDDAMAGE	= 1 << 4,//16
	COMBAT_LIFEDRAIN	= 1 << 5,//32
	COMBAT_MANADRAIN	= 1 << 6,//64
	COMBAT_HEALING		= 1 << 7,//128
	COMBAT_WATERDAMAGE	= 1 << 8,//256
	COMBAT_ICEDAMAGE	= 1 << 9,//512
	COMBAT_NORMALDAMAGE	= 1 << 10,//1024
	COMBAT_GHOSTDAMAGE	= 1 << 11,//2048
	COMBAT_ENERGYDAMAGE = 2070,
	COMBAT_EARTHDAMAGE = 2071,
	COMBAT_DROWNDAMAGE = 2072,
	COMBAT_HOLYDAMAGE = 2073,
	COMBAT_DEATHDAMAGE = 2074,
	COMBAT_POISONEDDAMAGE = 3009,
	COMBAT_BURNEDDAMAGE = 3008,
	COMBAT_FLYDAMAGE = 3003,
	COMBAT_GROUNDDAMAGE = 3000,
	COMBAT_ELECTRICDAMAGE = 3001,
	COMBAT_ROCKDAMAGE = 3002,
	COMBAT_BUGDAMAGE = 3004,
	COMBAT_FIGHTDAMAGE = 3005,
	COMBAT_DRAGONDAMAGE = 3006,
	COMBAT_POISONDAMAGE = 3007,
	COMBAT_DARKDAMAGE  = 3010,
	COMBAT_STEELDAMAGE = 3011,
	COMBAT_MIRACLEDAMAGE = 3024,
	COMBAT_DARK_EYEDAMAGE = 3025,
	COMBAT_SEED_BOMBDAMAGE = 3026,
	COMBAT_SACREDDAMAGE = 3027,
	COMBAT_MUDBOMBDAMAGE = 3028,
	COMBAT_LAST		= COMBAT_MUDBOMBDAMAGE
};
