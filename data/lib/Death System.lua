...
local Exps = {
	{minL = 1, maxL = 15, multipler = 5},
	{minL = 16, maxL = 20, multipler = 5},
	{minL = 21, maxL = 25, multipler = 5},
	{minL = 26, maxL = 30, multipler = 5},
	{minL = 31, maxL = 35, multipler = 5},
	{minL = 36, maxL = 40, multipler = 5},
	{minL = 41, maxL = 45, multipler = 5},
	{minL = 46, maxL = 50, multipler = 5},
	{minL = 51, maxL = 55, multipler = 5},
	{minL = 56, maxL = 60, multipler = 5},
	{minL = 61, maxL = 75, multipler = 5},
	{minL = 76, maxL = 90, multipler = 5},
	{minL = 91, maxL = 105, multipler = 5},
	{minL = 106, maxL = 120, multipler = 5},
	{minL = 121, maxL = 135, multipler = 5},
	{minL = 136, maxL = 150, multipler = 5},
	{minL = 151, maxL = 165, multipler = 5},
	{minL = 166, maxL = 180, multipler = 5},
	{minL = 181, maxL = 195, multipler = 5},
	{minL = 196, maxL = 210, multipler = 5},
	{minL = 211, maxL = 225, multipler = 5},
	{minL = 226, maxL = 250, multipler = 5},
	{minL = 251, maxL = 300, multipler = 5},
	{minL = 301, maxL = 350, multipler = 5},
}
