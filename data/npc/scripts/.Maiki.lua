...
function creatureSayCallback(cid, type, msg)
    ...
    local task = {
        ["Maiki"] = {{"Fearrow", 100}, {"Pidgeot", 100}, {"Snorlax", 100}},
    }
   
    local stoFinal = 9659456   
    if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then
        ...
        elseif getPlayerStorageValue(cid, stoFinal) ~= -1 then
            ...
            selfSay("Then, is a simple task, i want to you kill {50 Fearow, 100 Pidgeot, 50 Snorlax}, you accept the task?", cid)
