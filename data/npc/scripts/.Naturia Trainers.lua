...
["Seed Trainer"] = {
                       task1 = {
                             ["Seed Trainer"] = {{"Graveler", 50}, {"Starmie", 50}},
                       },                     
                       task2 = {
                             ["Seed Trainer"] = {{"Marowak", 100}, {"Blastoise", 100}},
                       },
                       itens = {{11441, 5}},
                       poke = "Tangela",
                       level = 90,
...
["Sprout Trainer"] = {
                       task1 = {
                             ["Sprout Trainer"] = {{"Raichu", 50}, {"Parasect", 50}},
                       },                     
                       task2 = {
                             ["Sprout Trainer"] = {{"Pinsir", 100}, {"Blastoise", 100}},
                       },
                       itens = {{11441, 5}},
                       poke = "Pinsir",
                       level = 100,
...
["Webhead Trainer"] = {
                       task1 = {
                             ["Webhead Trainer"] = {{"Blastoise", 50}, {"Jynx", 50}},
                       },                     
                       task2 = {
                             ["Webhead Trainer"] = {{"Muk", 100}, {"Charizard", 100}},
                       },
                       itens = {{11441, 5}},
                       poke = "Scyther",
                       level = 110,
...
["Woodtrunk Trainer"] = {
                       task1 = {
                             ["Woodtrunk Trainer"] = {{"Dragonite", 50}, {"Muk", 50}},
                       },                     
                       task2 = {
                             ["Woodtrunk Trainer"] = {{"Magmar", 100}, {"Charizard", 100}},
                       },
                       itens = {{11441, 5}},
                       poke = "Venusaur",
                       level = 120,
         ...
         elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'Yes')) and talkState[talkUser] == 1 then 
            if getPlayerStorageValue(cid, 854789) <= -1 then
               ...
               for a = 1, #npc.itens do
                   str = str.."{"..(npc.itens[a][2]).." "..(getItemNameById(npc.itens[a][1]))--(a == #npc.itens and " and " or a ~= 1 and ", " or "{")..(npc.itens[a][2]).." "..(getItemNameById(npc.itens[a][1]))
               end 
