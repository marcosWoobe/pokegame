...
function creatureSayCallback(cid, type, msg)
   ...
   ---------
   local need = {
      {id = 17272, qt = 75}, -- Sheep Wools
	  {id = 17285, qt = 100}, -- Dog Ears
   }
   local rewards = {
      {id = 2160, qt = 7}, -- money
   }
   local stoFinish = 93848
   ---------
   ...
   if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
      ...
      selfSay("Hello my friend, can you bring to me: 75 Sheep Wolls, 100 dog Ears? I will reward you!",cid)
   ...
   elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
      ...
      if getPlayerItemCount(cid, need[1].id) < need[1].qt then
         ...
         selfSay("Remember, you need to bring to me 75 Sheep Wolls, 100 dog Ears...", cid)
         talkState[talkUser] = 0
         return true
      end
      for i = 1, #need do
