...
function creatureSayCallback(cid, type, msg)
    ...
    ---------
    local need = {
        {id = 12205, qt = 100}, -- Onix Tail
	    {id = 12196, qt = 100}, -- Stone Orb
	    {id = 13867, qt = 50}, -- Strange Rocks
	    {id = 17288, qt = 20}, -- Steelix Tail
    }
    local rewards = {
        {id = 2160, qt = 1}, -- money
        {id = 11445, qt = 2}, -- Rock Stone
	    {id = 12232, qt = 1}, -- Metal Stone
    }
    local stoFinish = 93844
    ---------
    ...
    if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
        ...
        selfSay("Hello my friend, can you bring to me: 100 Onix Tail, 100 Stone Orb, 50 Strange Rocks, 20 Steelix Tail ? I will reward you!",cid)
    ...
    elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
        ...
        if getPlayerItemCount(cid, need[1].id) < need[1].qt then
            ...
            selfSay("Remember, you need to bring to me 100 Onix Tail, 100 Stone Orb, 50 Strange Rocks, 20 Steelix Tail...", cid)
            talkState[talkUser] = 0
            return true
        end
        for i = 1, #need do
