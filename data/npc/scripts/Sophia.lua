...
function creatureSayCallback(cid, type, msg)
   ...
   local need = {
      {id = 12208, qt = 50}, -- bone
	  {id = 17352, qt = 600}, -- earth ball
   }
   local rewards = {
      {id = 2152, qt = 50}, --money
      {id = 11451, qt = 1}, --earth stone
   }
   local stoFinish = 93830
   ---------
   ...
   if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
      ...
      selfSay("Hello my friend, can you bring to me: 50 bone, 600 earth ball ? I will reward you!",cid)
   ...
   elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
      ...
      if getPlayerItemCount(cid, need[1].id) < need[1].qt then
         ...
         selfSay("Remember, you need to bring to me 50 bone, 600 earth ball...", cid)
         talkState[talkUser] = 0
         return true
      end
      for i = 1, #need do
