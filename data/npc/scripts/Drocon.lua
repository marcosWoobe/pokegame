...
function creatureSayCallback(cid, type, msg)
    ...
    local need = {
	  ...
	  {id = 12152, qt = 100}, -- Pot of Lava
	  {id = 12159, qt = 10}, -- Dragon Tooth
    }
    local rewards = {
      {id = 2152, qt = 75}, --money
      {id = 11447, qt = 2}, -- Fire stone
    }
    local stoFinish = 93834
    ---------
    ...
    if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
        ...
        selfSay("Hello my friend, can you bring to me: 600 Essence of Fire, 10 Dragon Tooth, 100 Pot of Lava ? I will reward you!",cid)
    ...
    elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
	    ...
	    for i = 1, #need do
            if getPlayerItemCount(cid, need[i].id) < need[i].qt then
                ...
                selfSay("Remember, you need to bring to me 600 Essence of Fire, 10 Dragon Tooth, 100 Pot of Lava...", cid)
                talkState[talkUser] = 0
                return true
            end
		end
