...
local task = {
["Maria"] = {{"Bulbasaur", 50}, {"Ivysaur", 100}, {"Venusaur", 200}},
}
local stoFinal = 9659449
local tFinal = string.explode(getPlayerStorageValue(cid, stoFinal), ",") or {}
        ...
        if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then
           ...
           elseif isMyTaskComplete(cid, getNpcCid()) then
              ...
              selfSay("Then, is a simple task, i want to you kill {50 Bulbasaur, 100 Ivysaur, 200 Venusaur}, you accept the task?", cid)
