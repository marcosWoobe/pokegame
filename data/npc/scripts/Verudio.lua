...
function creatureSayCallback(cid, type, msg)
    ...
    ---------
    local need = {
        {id = 12174, qt = 50}, -- Rat Tail
	    {id = 12173, qt = 130}, -- biten apple
    }
    local rewards = {
        {id = 2152, qt = 55}, --money
        {id = 11451, qt = 1}, -- heart stone
    }
   ...
   ---------
    ...
    if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
        ...
        selfSay("Hello my friend, can you bring to me: 50 rat tail, 130 Biten Apple ? I will reward you!",cid)
    ...
    elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
	    ...
	    for i = 1, #need do
            if getPlayerItemCount(cid, need[i].id) < need[i].qt then
                ...
                selfSay("Remember, you need to bring to me 50 rat tail, 130 Bitten Apple...", cid)
                talkState[talkUser] = 0
                return true
            end
		end 
