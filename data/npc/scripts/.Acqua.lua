...
function creatureSayCallback(cid, type, msg)
    ...
    local task = {
        ["Acqua"] = {{"Squirtle", 150}, {"Wartortle", 120}, {"Blastoise", 100}},
    }
    
	local stoFinal = 9659455 
    if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then
        ...
        elseif getPlayerStorageValue(cid, stoFinal) ~= -1 then
            ...
            selfSay("Then, is a simple task, i want to you kill {150 Squirtle, 100 Wartortle, 80 Blastoise}, you accept the task?", cid)
