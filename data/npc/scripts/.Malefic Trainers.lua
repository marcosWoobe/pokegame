...
["Troublemaker Trainer"] = {
                       task1 = {
                             ["Troublemaker Trainer"] = {{"Machoke", 50}, {"Victreebel", 50}},
                       },                     
                       task2 = {
                             ["Troublemaker Trainer"] = {{"Vileplume", 100}, {"Venusaur", 100}},
                       },
                       itens = {{11450, 5}},
                       poke = "Weezing",
                       level = 90,
...
["Venomancer Trainer"] = {
                       task1 = {
                             ["Venomancer Trainer"] = {{"Wartortle", 50}, {"Raichu", 50}},
                       },                     
                       task2 = {
                             ["Venomancer Trainer"] = {{"Rhydon", 100}, {"Charizard", 100}},
                       },
                       itens = {{11450, 5}},
                       poke = "Umbreon",
                       level = 100,
...
["Spectre Trainer"] = {
                       task1 = {
                             ["Spectre Trainer"] = {{"Dragonair", 50}, {"Jynx", 50}},
                       },                     
                       task2 = {
                             ["Spectre Trainer"] = {{"Poliwrath", 100}, {"Tentacruel", 100}},
                       },
                       itens = {{11450, 5}},
                       poke = "Nidoking",
                       level = 110,
...
["Nightwalker Trainer"] = {
                       task1 = {
                             ["Nightwalker Trainer"] = {{"Rhydon", 50}, {"Golem", 50}},
                       },                     
                       task2 = {
                             ["Nightwalker Trainer"] = {{"Dragonite", 100}, {"Blastoise", 100}},
                       },
                       itens = {{11450, 5}},
                       poke = "Houndoom",
                       level = 120,
...
local npc = clanNpcs[getNpcName()]
         ...
         if msgcontains(msg, 'help') or msgcontains(msg, 'Help') then
            if getPlayerLevel(cid) < npc.level or getPlayerClanName(cid) ~= 'Malefic' or getPlayerClanRank(cid) ~= npc.prevRank then
               selfSay("i don't need your help, come back when you are stronger! {Lv."..npc.level.."}", cid)
