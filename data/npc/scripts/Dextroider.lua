...
function creatureSayCallback(cid, type, msg)
   ...
   ---------
   local need = {
      {id = 17299, qt = 20}, -- Steel Wing
	  {id = 17292, qt = 20}, -- Bear Paw
   }
   local rewards = {
      {id = 2160, qt = 5}, -- money
   }
   local stoFinish = 93847
   ---------
   ...
   if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
      ...
      selfSay("Hello my friend, can you bring to me: 20 Steel Wing, 20 Bear Paw? I will reward you!",cid)
   ...
   elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
      ...
      if getPlayerItemCount(cid, need[1].id) < need[1].qt then
         ...
         selfSay("Remember, you need to bring to me 20 Steel Wing, 20 Bear Paw...", cid)
         talkState[talkUser] = 0
         return true
      end
      for i = 1, #need do
