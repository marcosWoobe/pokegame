...
msg = string.lower(msg)
        ...
        if (msgcontains(msg, 'outfit') or msgcontains(msg, 'outfits')) then
           selfSay("Essas são as outfits que tenho: {Jamaican, Rapper, Oriental, Adventurer, Bussines, Atletic, Punk, Mercenary e Hiker}, qual você gostou??", cid)
              ...
              if getPlayerPremiumDays(cid) > 0 then
                 if getPlayerMoney(cid) >= 20000 then
                    ...
                    setPlayerStorageValue(cid, outfit[1], 1)
                     ...
                     selfSay("Você precisa de 10k para comprar essa outfit!", cid)
