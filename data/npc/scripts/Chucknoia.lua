...
function creatureSayCallback(cid, type, msg)
   ...
   ---------
   local need = {
      {id = 12191, qt = 50}, -- Punch Machine
	  {id = 17332, qt = 50}, -- Plant Foot
	  {id = 2345, qt = 50}, -- martial arts scroll
	  {id = 17346, qt = 300}, -- Band Aids
   }
   local rewards = {
      {id = 2152, qt = 75}, -- money
   ...
   if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
      ...
      selfSay("Hello my friend, can you bring to me: 50 Punch Machine, 50 Plant Foot, 50 Martil Arts Scroll, 300 Band aids? I will reward you!",cid)
   ...
   elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
      ...
      if getPlayerItemCount(cid, need[1].id) < need[1].qt then
         ...
         selfSay("Remember, you need to bring to me 50 Punch Machine, 50 Plant Foot, 50 Martil Arts Scroll, 300 Band aids...", cid)
         talkState[talkUser] = 0
         return true
      end
      for i = 1, #need do
