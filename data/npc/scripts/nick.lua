...
if (msgcontains(msg, 'hi') and (focus == 0) and (getDistanceToCreature(cid) <= 4)) then
	...
	conv = 1
	talk_start = os.clock()
	selfSay("Olá, "..getCreatureName(cid).."! eu dou um apelido para seu pokemon digite nick para mudar de nome, ou ponho uma aura elemental mais ele precisa estar boostado +50 para ter aura...")
