...
local task = {
["Kiara"] = {{"Haunter", 50}, {"Misdreavus", 100}, {"Gengar", 200}},
}
...
local tFinal = string.explode(getPlayerStorageValue(cid, stoFinal), ",") or {}
        ...
        doPlayerAddExp(cid, 1000000) -- Xp
              ...
              selfSay("Then, is a simple task, i want to you kill {50 Haunter, 100 Misdreavus, 200 Gengar}, you accept the task?", cid)
