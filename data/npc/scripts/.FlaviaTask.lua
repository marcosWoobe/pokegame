...
function creatureSayCallback(cid, type, msg)
    ...
    local task = {
        ["Flavia"] = {{"Raichu", 150}, {"Elekid", 150}, {"Electabuzz", 100}},
    }

    local stoFinal = 9659452
    if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then 
        ...
        elseif getPlayerStorageValue(cid, stoFinal) ~= -1 then
            ...
            selfSay("Then, is a simple task, i want to you kill {150 Raichu, 150 Elekid, 100 Electabuzz}, you accept the task?", cid)
