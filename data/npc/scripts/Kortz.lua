...
function creatureSayCallback(cid, type, msg)
   ...
   ---------
   local need = {
      {id = 12204, qt = 60}, -- Traces OF Ghost
	  {id = 12206, qt = 400}, -- Essence of Darkness
   }
   local rewards = {
      {id = 2152, qt = 60}, --money
      {id = 11450, qt = 1}, -- Darkness Stone
   }
   local stoFinish = 93836
   ---------
   ...
   if msgcontains(msg, 'help') or msgcontains(msg, 'ajuda') then
      ...
      selfSay("Hello my friend, can you bring to me: 60 Traces of Ghost, 400 Essence of Darkness ? I will reward you!",cid)
   ...
   elseif msgcontains(msg, 'yes') or msgcontains(msg, 'sim') and talkState[talkUser] == 1 then
      ...
      if getPlayerItemCount(cid, need[1].id) < need[1].qt then
         ...
         selfSay("Remember, you need to bring to me 60 Traces of Ghost, 400 Essence of Darkness...", cid)
         talkState[talkUser] = 0
         return true
      end
      for i = 1, #need do
