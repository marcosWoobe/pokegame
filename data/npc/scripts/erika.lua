...
local pokemons = {
{name = "Scizor", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "normal"},
...
{name = "Meganium", optionalLevel = 450, sex = SEX_FEMALE, nick = "", ball = "normal"},
{name = "Venusaur", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "normal"},
{name = "Scyther", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "normal"},
