...
local task = {
["Diego"] = {{"Hitmonlee", 70}, {"Machoke", 50}, {"Machamp", 100}, {"Hitmontop", 70}, {"Hitmonchan", 70}},
}
...
local tFinal = string.explode(getPlayerStorageValue(cid, stoFinal), ",") or {}
        ...
        if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then
           ...
           elseif isMyTaskComplete(cid, getNpcCid()) then
			  ...
			  doPlayerAddItem(cid, 15645, 15) -- Devoted Token
              ...
              selfSay("Then, is a simple task, i want to you kill {70 Hitmonlee, 70 Hitmonchan, 100 Machamp, 50 Machoke, 70 Hitmontop}, you accept the task?", cid)
