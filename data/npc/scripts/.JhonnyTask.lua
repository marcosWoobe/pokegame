...
local task = {
["Jhonny"] = {{"Abra", 50}, {"Kadabra", 100}, {"Alakazam", 200}, {"Hypno", 150}},
}
        ...
        if msgcontains(msg, 'task') or msgcontains(msg, 'Task') then
           ...
           elseif isMyTaskComplete(cid, getNpcCid()) then
			...
			doPlayerAddItem(cid, 2160, 10)  -- Dinheiro
              ...
              selfSay("Then, is a simple task, i want to you kill {50 Abras, 100 Kadabras, 150 Hypnos and 200 Alakazams}, you accept the task?", cid)
