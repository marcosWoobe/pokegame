...
function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, 'task') or msgcontains(msg, 'ajuda') then
        if isMyTaskComplete(cid, getNpcCid()) then
			...
			doPlayerAddItem(cid, 11445, 8) -- Rock Stone
	    ...
	    elseif getPlayerStorageValue(cid, stoFinal) ~= -1 then
            ...
            selfSay("Then, is a simple task, i want to you kill {10 Golem, 100 Rhydon, 100 Onix}, you accept the task?", cid)
