...
local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
      ...
      elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'Yes')) and talkState[talkUser] == 3 then 
            if getCreatureName(cid) == "Meti Pelada" and getPlayerStorageValue(cid, 91831) < 1 then
                setPlayerClan(cid, 'Gardestrike')
                selfSay("Now you are member of the Gardestrike clan.", cid)
                selfSay("Hugs, Cray.", cid)
        ...
        elseif (msgcontains(msg, 'yes') or msgcontains(msg, 'Yes')) and talkState[talkUser] == 4 then
           ...
           if doPlayerRemoveMoney(cid, 50000000) == true then
			...
			doItemSetAttribute(pb, "addonNow", getOutfitPoke("Shiny Vileplume"))
			for i = 0, 7 do
