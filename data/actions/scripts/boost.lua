...
function onUse(cid, item, topos, item2, frompos)
    ...
    if item.itemid == button then
        ...
        local myball = getDepotItem(ball_slot.uid, 0, cid, 3)--getContainerItem(ball_slot.uid, 0) 
		...
		if memoryDitto and memoryDitto ~= "" then
		    doPlayerSendCancel(cid, "Destransforme o Ditto.")
            return true
		end
