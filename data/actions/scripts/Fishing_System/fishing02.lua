local fishing = {
[-1] = { segs = 5, bonus = 2, pokes = {{"Magikarp", 2}} },

[3976] = { segs = 5, bonus = 5, pokes = {{"Horsea", 2}, {"Goldeen", 2}, {"Poliwag", 2}} },  -- pega no client da pxg

[12855] = { segs = 5, bonus = 6, pokes = {{"Tentacool", 2}, {"Krabby", 2}} },

[12854] = { segs = 5, bonus = 7, pokes = {{"Seel", 2},  {"Slowpoke", 2}} },

[12858] = { segs = 5, bonus = 8, pokes = {{"Seaking", 2}, {"Poliwhirl", 2}} },

[12857] = { segs = 5, bonus = 9, pokes = {{"Starmie", 2}, {"Kingler", 2}} },  -- pega no client da pxg

[12860] = { segs = 2, bonus = 10, pokes = { {"Dewgong", 2}, {"Slowbro", 2}} },

[12859] = { segs = 2, bonus = 11, pokes = {{"Cloyster", 2}, {"Poliwrath", 2}} },

[12856] = { segs = 2, bonus = 12, pokes = {{"Dratini", 1}, {"Dragonair", 1}} },

[12853] = { segs = 2, bonus = 13, pokes = {{"Gyarados", 1}, {"Giant Magikarp", 1}} },
}
...
--end
    if getPlayerSkillLevel(cid, 6) < 20 then  
	    doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_ORANGE, "Voce precisar ter no min fishing 20")
	    return true
	end
