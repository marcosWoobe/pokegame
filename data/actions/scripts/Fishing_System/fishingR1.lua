local fishing = {
[-1] = { segs = 5, bonus = 5, pokes = {{"Magikarp", 4}} },

[3976] = { segs = 5, bonus = 8, pokes = {{"Goldeen", 4}, {"Poliwag", 4}} },  -- pega no client da pxg

[12855] = { segs = 5, bonus = 9, pokes = {{"Tentacool", 4}, {"Krabby", 4}} },

[12854] = { segs = 5, bonus = 10, pokes = {{"Seel", 4},  {"Slowpoke", 4}} },

[12858] = { segs = 5, bonus = 11, pokes = {{"Seaking", 4}, {"Poliwhirl", 4}} },

[12857] = { segs = 5, bonus = 12, pokes = {{"Starmie", 4}, {"Kingler", 4}} },  -- pega no client da pxg

[12860] = { segs = 2, bonus = 13, pokes = { {"Dewgong", 4}, {"Slowbro", 4}} },

[12859] = { segs = 2, bonus = 14, pokes = {{"Cloyster", 4}, {"Poliwrath", 4}} },

[12856] = { segs = 2, bonus = 15, pokes = {{"Dratini", 3}, {"Dragonair", 3}} },

[12853] = { segs = 2, bonus = 16, pokes = {{"Gyarados", 2}, {"Giant Magikarp", 2}} },
}
