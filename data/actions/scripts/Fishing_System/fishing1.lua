...
[3976] = { segs = 5, pokes = {{"Horsea", 5}, {"Goldeen", 3}, {"Poliwag", 2}} },  -- pega no client da pxg

[12855] = { segs = 5, pokes = {{"Tentacool", 3}, {"Staryu", 2}, {"Krabby", 3}, {"Shellder", 2}, {"Omanyte", 3}} },

[12854] = { segs = 5, pokes = {{"Seel", 2},  {"Slowpoke", 2}, {"Psyduck", 2}} },

[12858] = { segs = 5, pokes = {{"Seaking", 2}, {"Seadra", 2}, {"Poliwhirl", 2}, {"Squirtle", 2}, {"Totodile", 2}} },

[12857] = { segs = 5, pokes = {{"Starmie", 2}, {"Kingler", 2}} },  -- pega no client da pxg

[12860] = { segs = 2, pokes = { {"Dewgong", 2}, {"Slowbro", 2}} },

[12859] = { segs = 2, pokes = {{"Cloyster", 2}, {"Poliwrath", 2}} },

[12856] = { segs = 2, pokes = {{"Dratini", 3}, {"Quagsire", 2}, {"Dragonair", 2}, {"Omastar", 2}, {"Lapras", 1}} },

[12853] = { segs = 2, pokes = {{"Gyarados", 1},  {"Tentacruel", 1},  {"Giant Magikarp", 1}, {"Blastoise", 1}} },
}
...
if getPlayerStorageValue(cid, 5700) >= 1  then
	doPlayerSendCancel(cid, "You can't using bike.")
return true
end
...
if not isInArray({520, 521}, getCreatureOutfit(cid).lookType) then
 ...
 -- doCreatureChangeOutfit(summon[1], {lookType = out.lookType, lookLegs = out1.lookBody})
   doSetCreatureOutfit(cid, {lookType = 1467, lookHead = outfit.lookHead, lookBody = outfit.lookBody, lookLegs = outfit.lookLegs, lookFeet = outfit.lookFeet}, -1)
     ...
     doCreatureChangeOutfit(cid, {lookType = 1467, lookHead = outfit.lookHead, lookBody = outfit.lookBody, lookLegs = outfit.lookLegs, lookFeet = outfit.lookFeet}, -1)
end
end
