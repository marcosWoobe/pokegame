function onCastSpell(cid, var)
    ...
    ---------------------fim da padrão /\ e aparti daqui \/ é o code da spell------------------------------
      ...
      if getPlayerStorageValue(cid, 32624) == 1 then  --proteÃ§ao pra n usar a spell 2x seguidas...
      return true
      end
      
      local function damage(cid)
      if isCreature(cid) then
         doAreaCombatHealth(cid, NORMALDAMAGE, getThingPosWithDebug(cid), bombWee2, -min, -max, 77)
      end
      end
      ...
      addEvent(setPlayerStorageValue, 3500, cid, 32624, 0)        --proteÃ§ao
