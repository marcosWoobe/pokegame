function onCastSpell(cid, var)
    ...
    ---------------------fim da padrão /\ e aparti daqui \/ é o code da spell------------------------------
		...
		if getCreatureOutfit(cid).lookType == 1301 then
			print("Error aconteceu com o move 'Elemental Hands', a outfit do hitmonchan esta incorreta, reporte isso para a equipe um Administrador do PokeNumb")
			doPlayerSendTextMessage(getCreatureMaster(cid), MESSAGE_STATUS_CONSOLE_BLUE, "Aconteceu um erro... Uma mensagem foi enviada para os Administradores do PokeNumb") 
			return true
