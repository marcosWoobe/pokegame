...
void MonsterType::dropLoot(Container* corpse)
{
	...
	std::stringstream ss;
	if(aulootMsg != "")
		ss << "Loot do " << nameDescription << ": " << corpse->getContentDescription() << " and " << aulootMsg << " was auto looted.";
	else
	    ss << "Loot do " << nameDescription << ": " << corpse->getContentDescription() << ".";
